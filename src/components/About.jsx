...
export default function About() {
  return (
    <section
      id="about"
      className="bg-blue-900/10 px-6 pt-6 pb-16"
    >
      <motion.div
        ...
        className="bg-blue-200/40 px-10 md:px-20 py-12 rounded-2xl shadow-md max-w-5xl mx-auto border border-blue-400"
      >
        <h2 className="text-3xl font-semibold border-b-2 border-sky-400 pb-2 mb-6 text-black text-center">
          About Me
        </h2>
